            ...
            <div>
              ...
              <div className="space-y-6 text-gray-700 leading-relaxed text-lg">
                <p className="relative pl-6">
                  ...
                  شركة Eduvento بدأت سنة 2024 برؤية واضحة: إن التعليم التقني
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="card-primary hover:shadow-2xl group relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-300 leading-relaxed text-lg group-hover:text-gray-800 transition-colors duration-300">
                  ...
                  ومتصمم عشان يواكب متطلبات سوق العمل دلوقتي. إحنا بنؤمن إن
            ...
            <div className="card-primary hover:shadow-2xl group relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-300 leading-relaxed text-lg group-hover:text-gray-800 transition-colors duration-300">
                  رؤيتنا إننا نكون الشركة الرائدة والأكثر ثقة في التعليم الرقمي
          ...
          {[
            {
              ...
              title: "محتوى عملي",
              desc: "متصمم عشان تحقق نتايج حقيقية في سوق العمل مع مشاريع على أرض الواقع",
              color: "primary",
              delay: 0,
            },
            {
